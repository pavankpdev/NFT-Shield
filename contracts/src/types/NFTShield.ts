...
export interface NFTShieldInterface extends utils.Interface {
  functions: {
...
export interface NFTShield extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTShieldInterface;
  ...
  functions: {
    ...
    getAllTokens(overrides?: CallOverrides): Promise<[BigNumber[], string[]]>;
  ...
  callStatic: {
    addToBlacklist(user: string, overrides?: CallOverrides): Promise<void>;
    ...
    removeFromBlacklist(user: string, overrides?: CallOverrides): Promise<void>;
